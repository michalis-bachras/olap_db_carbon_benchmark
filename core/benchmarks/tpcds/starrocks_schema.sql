...
DISTRIBUTED BY HASH(w_warehouse_sk)
PROPERTIES ("replication_num" = "1");
...
DISTRIBUTED BY HASH(sm_ship_mode_sk)
PROPERTIES ("replication_num" = "1");
...
DISTRIBUTED BY HASH(r_reason_sk)
PROPERTIES ("replication_num" = "1");
...
DISTRIBUTED BY HASH(ib_income_band_sk)
PROPERTIES ("replication_num" = "1");
...
DISTRIBUTED BY HASH(s_store_sk)
PROPERTIES ("replication_num" = "1");
...
DISTRIBUTED BY HASH(cc_call_center_sk)
PROPERTIES ("replication_num" = "1");
...
DISTRIBUTED BY HASH(sr_item_sk, sr_ticket_number)
PROPERTIES ("replication_num" = "1");
...
DISTRIBUTED BY HASH(cr_item_sk, cr_order_number)
PROPERTIES ("replication_num" = "1");
...
DISTRIBUTED BY HASH(wr_item_sk, wr_order_number)
PROPERTIES ("replication_num" = "1");
...
DISTRIBUTED BY HASH(ws_item_sk, ws_order_number)
PROPERTIES ("replication_num" = "1");
...
DISTRIBUTED BY HASH(cs_item_sk, cs_order_number)
PROPERTIES ("replication_num" = "1");
